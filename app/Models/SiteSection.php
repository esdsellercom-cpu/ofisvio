...
{
    protected $fillable = ['website_id', 'type', 'anchor', 'sort_order', 'is_visible', 'hide_on_mobile', 'hide_on_desktop', 'settings', 'publish_from', 'publish_until', 'updated_by'];

    protected $casts = [
        'settings' => 'array', 'is_visible' => 'boolean', 'hide_on_mobile' => 'boolean', 'hide_on_desktop' => 'boolean',
    ...
    public function toSnapshot(): array
    {
        return [
            ...
            'hide_on_mobile' => $this->hide_on_mobile, 'hide_on_desktop' => $this->hide_on_desktop,
