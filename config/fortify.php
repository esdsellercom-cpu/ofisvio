...
return [
    ...
    */
    ...
    /*
    | OFISVIO: Kayıt (registration) KASITLI OLARAK KAPALI. Kullanıcılar
    | organizasyon üyeliğiyle var olur — personel müşteri organizasyonunu
    | açar ve sahibini davet eder (bkz. OrganizationOnboardingService).
