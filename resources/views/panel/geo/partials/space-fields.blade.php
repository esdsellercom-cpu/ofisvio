...
<div class="grid-auto" style="--min:150px;--gap:12px">
    ...
    <label class="field"><span class="label">Aylık ücret (₺, KDV hariç)</span><input class="control mono" type="number" step="0.01" name="monthly_price" value="{{ \App\Support\Money::major($s?->monthly_price ?? 0) }}" min="0"></label>
