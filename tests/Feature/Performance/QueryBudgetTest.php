...
class QueryBudgetTest extends TestCase
{
    ...
    private const BUDGET = [
        'vitrin' => 14, // +1 yönlendirme haritası (faz 54, önbellekli); booking engine: odalar + lokasyonları (2), onay politikası ayarı (1), hizmetler (1, önbellekli) + lokasyon→hizmet ilişkisi (1) — sahte kart yerine canlı veri; +1 tek lokasyon tespiti (faz 53, istek başına bir kez)
        ...
        'site.post' => 14, // +1 Knowledge Graph ilişkileri (faz 60b; önbellekli tek okuma) · +1 sayfa kurucu: üst menü yayınlanmış bölümlerden (revizyon okuma, önbellekli); +1 tek lokasyon tespiti (faz 53); +1 yönlendirme haritası (faz 54, önbellekli); +2 canlı düzenleme yetki kararı (faz 59; yalnız oturum açık kullanıcı — test admin ile ölçer, ziyaretçide yok)
    ];
